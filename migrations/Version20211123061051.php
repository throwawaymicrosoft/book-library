 ...
 */
final class Version20211123061051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, author_id INT NOT NULL, title TEXT NOT NULL, cover VARCHAR(255) DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, read_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, downloadable BOOLEAN DEFAULT NULL, original_file_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
